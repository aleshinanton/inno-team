...
TEST_GRANTSTATUSPROBA = dict(CONFIG[MODEL])

# путь к данным модели
model_path = TEST_GRANTSTATUSPROBA['model_path']
# имя модели для сохранения объекта
model_name = TEST_GRANTSTATUSPROBA['model_name']
# имя файла с данными для ОБУЧЕНИЯ модели
data_train_filename = model_path + TEST_GRANTSTATUSPROBA['data_train']
...
def model_prediction(model_pipeline, request_dict):
    ...
    return str(model_pipeline.predict_proba(X_pred)[0][1])
